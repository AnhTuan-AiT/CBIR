...
from v2.ShapeDescriptor import ShapeDescriptor
...
for file in data_list:
    ...
    imgID = file[0]
    color_histogram_feature = feature_descriptor.describe(img)
    humoments_feature = shape_descriptor.describe(img)

    # write id, features to output
    index_obj.write_all_features_into_Index(imgID, color_histogram_feature, humoments_feature)
